...
export default function InquiryForm() {
  ...
  return (
    <>
      ...
      {showModal ? (
        <>
          <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 overflow-y-auto  outline-none focus:outline-none">
            <div className=" w-auto my-6 mx-auto max-w-3xl">
              {/*content*/}
              <div className="border border-accent p-9 rounded-lg shadow-lg relative flex flex-col w-full bg-secondary outline-none focus:outline-none mt-9">
                {/*header*/}
                ...
                {isOpen && (
                  <p className="max-w-md my-6 text-lg">
                    Thank you for reaching out! Please check your email for
                    confirmation, and we will get back to you as soon as
                    possible.
                  </p>
                )}
                <button
